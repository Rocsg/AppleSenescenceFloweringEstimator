...
isoVal=127.5
actorMoelle=build_actor_from_mesh_file(source_rep+'moe_mesh.vtp',r,g,b,opac,spec,diff,amb,isoVal,z_begin_irm,z_end_irm,y_last,z_last,size)
...
isoVal=57.5
actorCambium=build_actor_from_mesh_file(source_rep+'camb_mesh.vtp',r,g,b,opac,spec,diff,amb,isoVal,z_begin_irm,z_end_irm,y_last,z_last,size)
...
isoVal=192.5
actorVessels=build_actor_from_mesh_file(source_rep+'ves_mesh.vtp',r,g,b,opac,spec,diff,amb,isoVal,z_begin_irm,z_end_irm,y_last,z_last,size)
...
isoVal=117.5
actorSegD3=build_actor_from_mesh_file(source_rep+'D3_mesh.vtp',r,g,b,opac,spec,diff,amb,isoVal,z_begin_irm,z_end_irm,y_end,z_end,size)
...
isoVal=227.5
actorSegD2=build_actor_from_mesh_file(source_rep+'D2_mesh.vtp',r,g,b,opac,spec,diff,amb,isoVal,z_begin_irm,z_end_irm,y_end,z_end,size)
...
isoVal=237.5
actorSegD1=build_actor_from_mesh_file(source_rep+'D1_mesh.vtp',r,g,b,opac,spec,diff,amb,isoVal,z_begin_irm,z_end_irm,y_end,z_end,size)
...
isoVal=247.5
actorSegD0=build_actor_from_mesh_file(source_rep+'D0_mesh.vtp',r,g,b,opac,spec,diff,amb,isoVal,z_begin_irm,z_end_irm,y_end,z_end,size)
