...
def get_image_constants_2(crop_type=0):    
    ...
    if(crop_type==0):
        ...
        x0, y0, z0, xf, yf, zf=0,0,sliceMedZ, 145,size_y,size_z
    elif(crop_type==5) :
        x0, y0, z0, xf, yf, zf=0,0,130, 0,0,285
...
def setup_rectangle(day_max,mobile_rendering,renderer,proportion=0.32,at_the_top=True,r=0,g=0,b=0):
    ...
    textActor.GetTextProperty().SetOpacity(0.7)
