...
def create_lookup_table(intensity_min,intensity_max,sat_min,sat_max,hue_min,hue_max,cont_min,cont_max):
    print('Standard colormap creation Valeurs à traiter (intensity_min,intensity_max,sat_min,sat_max,hue_min,hue_max,cont_min,cont_max)='+str(intensity_min)+', '+str(intensity_max)+', '+str(sat_min)+', '+str(sat_max)+', '+str(hue_min)+', '+str(hue_max)+', '+str(cont_min)+', '+str(cont_max))
...
def create_bw_lookup_table(thresh_start,thresh_stop,val_start,val_stop):
    print('BW Colormap creation Valeurs à traiter (thresh_start,thresh_stop,val_start,val_stop)='+str(thresh_start)+', '+str(thresh_stop)+', '+str(val_start)+', '+str(val_stop))
...
def get_silhouette_colours():
    return  0.8, 0.8,1.0 ,        0.09, 0.2 ,0.3,0.18           ,1.0 , 1.0  ,1.0 
    #          r,g,b,                opac,spec,diff,amb ,       spec_r,spec_g,spec_b
